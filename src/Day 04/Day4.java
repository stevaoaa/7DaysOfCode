...
/**
 * Goal: Create a class to handle HTML generation.
 */
...
public class Day4 {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String[] listOfMoviesInString = parseJsonMovies(jsonMovies);

        // encapsulate the list into a list of objects instance of Movie class
        List<Movie> listOfMovies = getMovies(listOfMoviesInString);
